...
export default function HeroSection({ onGetStarted }: { onGetStarted: () => void }) {
  return (
    <section className="relative w-full max-w-7xl mx-auto px-6 py-12 md:py-20 flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <h1 className="relative z-10 text-7xl md:text-8xl font-extrabold bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-500 bg-clip-text text-transparent drop-shadow-lg animate-pulse">
        Welcome to VoSo
      </h1>
